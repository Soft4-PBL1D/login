...
<!-- id=出席：0遅刻(自己都合)：1欠席：2就活：3病欠：4公欠：5遅延:6 -->
          ...
          <a id="select_box" href="###############やり直しの際の処理.php################">
            <!-- 自己都合idは早退時のみ２（欠席）になる -->
            <a href="../ClassAttend/classleave.php?id=2" id="choice_btn3"><div class="tabler">
              <p>自己都合</p>
            </div></a>
            <a href="../ClassAttend/classleave.php?id=6" id="choice_btn3" name="tien" value="7"><div class="tabler">
              <p>遅延</p>
            </div></a>
            <a href="../ClassAttend/classleave.php?id=7" id="choice_btn3" style="  margin-right:0px;" name="shukatu" value="3"><div class="tabler">
              <p>就活</p>
            </div></a>
          </a>
